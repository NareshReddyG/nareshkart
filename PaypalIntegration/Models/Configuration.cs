...
namespace PaypalIntegration.Models
{
    ...
    public static class Configuration
    {
        ...
        public static Dictionary<string, string> GetAcctAndConfig()
        {
            ...
            configMap.Add("account1.apiUsername", "naresh.merchant.us_api1.paypal.com");
            configMap.Add("account1.apiPassword", "3MT2GYEG2273MH9X");
            configMap.Add("account1.apiSignature", "AIO8AES7S01PbIFstmJoRimMCPNmAVk5ASLWHqFGTjv.jexYJHaNkdXN");
            // Optional
